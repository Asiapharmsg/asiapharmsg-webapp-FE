          ...
          <Col lg={12}>
            <div className="brand-carousel-content text-center space-mb--50">
              ...
              <p className="brand-carousel-content__text">
                “ Our mission is to create a safe space in our digital world where everyone can get 
                competitively priced pharmaceutical products reliably and conveniently. ”
              </p>
            </div>
            {/*
